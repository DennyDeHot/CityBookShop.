...
public class Manegerlogin extends javax.swing.JFrame {
  ...
  Connection con = null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome toManager Login");

        jLabel2.setFont(new java.awt.Font("Segoe UI Emoji", 1, 14)); // NOI18N
        jLabel2.setText("Manger User Name");
        ...
        jLabel3.setText("Manger Password");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (username.getText().length() <= 0 || password.getText().length() <= 0) {
            ...
            try {
                ...
                String sql = ("SELECT * FROM logindatabase2 WHERE username=?  AND  password=?  ");//tablename
                ...
                if (rs.next()) {   // its true do this
                    ...
                    JOptionPane.showMessageDialog(rootPane, "<html><b style = \" font-size:12px;\">You're Logged in...</b></html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manegerlogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Manegerlogin().setVisible(true);
            }
        });
    }
